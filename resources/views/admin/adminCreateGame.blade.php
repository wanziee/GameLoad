...
@section('content')
    <style>
        ...
        input::placeholder {
            color: #787878 !important; /* Warna placeholder (contoh: oranye) */
            opacity: 1; /* Atur opasitas, 1 adalah 100% */
        }
    ...
    <div class="p-4">
        <div class="row">
            <div class="col-12">
                ...
                <ol class="breadcrumb  d-lg-flex mb-4 align-items-center">
                    ...
                    <li class="breadcrumb-item edit-game">Create Game
                    </li>
                </ol>
                <!-- Breadcrumb end -->
            </div>
        </div>
        <h2 class="text-white">Create Game</h2>
        ...
        <form action="{{ route("admin.games.create")}}" method="POST"  enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nama_game') is-invalid @enderror" id="nama_game" name="nama_game" placeholder="Masukkan Nama Game...">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('detail') is-invalid @enderror" id="detail" name="detail"
                    rows="4" placeholder="Masukkan Detail Game..."></textarea>
                @error('detail')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
